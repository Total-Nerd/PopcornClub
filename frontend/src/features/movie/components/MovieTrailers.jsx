...
const MovieTrailers = () => {
  const { movieDetails, activeTrailerKey, setActiveTrailerKey } = useMovieStore();

  if (!movieDetails || !movieDetails.videos) return null;

  const trailers = movieDetails.videos.filter(v => v.site === 'YouTube' && (v.type === 'Trailer' || v.type === 'Teaser'));
